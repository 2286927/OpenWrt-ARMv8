...
svn export https://github.com/kiddin9/kwrt-packages/trunk/luci-app-webdav package/luci-app-webdav
#git clone --depth 1 https://github.com/sirpdboy/luci-app-cupsd package
svn export https://github.com/kiddin9/kwrt-packages/trunk/luci-app-cupsd package/luci-app-webdav
